...
import { CreateDevTaskRequest, TaskCategory, TaskPriority } from '../../types/devTaskTypes';
...
const QuickAddTask = ({ onCreate }: QuickAddTaskProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-6 border border-gray-200 dark:border-gray-700">
      <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-white">Add New Task</h3>
