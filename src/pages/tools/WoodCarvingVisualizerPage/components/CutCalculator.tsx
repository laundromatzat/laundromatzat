...
const MeasurementWorkbench: React.FC<WorkbenchProps> = ({
  imageUrl,
  unit,
  onClose,
}) => {
  ...
  useEffect(() => {
    ...
    if (!isNaN(num) && num > 0) {
      setMeasureState((prev) => ({
        ...
        pixelsPerUnit: prev.referenceLinePixels
          ? prev.referenceLinePixels / num
          : null,
      }));
    }
  }, [physicalHeight]);
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-sage-900 flex flex-col animate-fade-in">
      ...
      <div className="bg-sage-800 p-4 shadow-md flex flex-col md:flex-row justify-between items-center z-50 gap-4 border-b border-sage-700">
        <div className="flex items-center gap-6">
          ...
          <div className="flex gap-2 bg-sage-900/50 p-1 rounded-lg">
            ...
            <button
              ...
              title={
                !measureState.pixelsPerUnit
                  ...
                  : "Step 2: Draw lines to measure distances"
              }
              className={`px-4 py-2 rounded-md flex items-center gap-2 text-sm font-medium transition-colors ${
                mode === "measure"
            ...
            <button
              onClick={() =>
                setMeasureState((prev) => ({ ...prev, measurements: [] }))
              }
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative group">
            ...
            />
            <span className="absolute right-3 top-2.5 text-sage-500 text-sm font-bold">
      ...
      {/* Helper Banner */}
      <div
        className={`text-center py-2 text-sm font-medium transition-colors ${mode === "calibrate" ? "bg-blue-900/50 text-blue-200" : "bg-red-900/50 text-red-200"}`}
      >
        {mode === "calibrate"
    ...
    <>
      ...
      <div className="mt-4 flex flex-col md:flex-row gap-8 items-center justify-between">
        ...
        <div className="flex-1 space-y-4 max-w-md">
          <h4 className="text-xl font-bold text-sage-800">
            Precision Measurement
          </h4>
          <p className="text-sage-600">
            Open the interactive workbench to calibrate your design against your
            real-world wood block. You can draw multiple cut lines to get exact
            dimensions for every stage of your carving.
          </p>
          <button
            onClick={() => setIsOpen(true)}
